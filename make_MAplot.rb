...
class MakeMAplot
  ...
  private
    ...
    def write_MAplot_r
      ...
      erb = ERB.new(IO.read("#{x_seq_dir}/MAplot.r.erb"))
      File.open("./MAplot.r", "w") { |f| f.print erb.result(binding) }
    end
end

if __FILE__ == $0
  make_MAplot = MakeMAplot.new(ARGV)
  make_MAplot.create_MAplot
end
